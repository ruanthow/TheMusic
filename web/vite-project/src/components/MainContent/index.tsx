...
import { AiOutlinePlayCircle, AiOutlineBars, AiOutlinePlusCircle } from 'react-icons/ai'
                ...
                <div className={styles.footer}>
                    <div className={styles.maisTocadas}>
                        {data?.map((music: MusicType, key: Key) => {
                            return (
                                <div className={styles.dataItem} key={key} onClick={() => setButtonOptionsMobile(true)}>
                                    <img src={music.imagem} alt="Capa do Album" />
